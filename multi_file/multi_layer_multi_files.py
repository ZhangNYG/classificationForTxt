...
def mode_base():
    ...
    hiddenLayer1 = add_layer("layer1", x_input, in_size=128, out_size=256, activation_function=tf.tanh)

    hiddenLayer2 = add_layer("layer2", hiddenLayer1, in_size=256, out_size=256, activation_function=tf.tanh)

    hiddenLayer3 = add_layer("layer3", hiddenLayer2, in_size=256, out_size=128, activation_function=tf.tanh)

    hiddenLayer4 = add_layer("layer4", hiddenLayer3, in_size=128, out_size=64, activation_function=tf.tanh)

    hiddenLayer5 = add_layer("layer5", hiddenLayer4, in_size=64, out_size=32, activation_function=tf.tanh)

    hiddenLayer6 = add_layer("layer6", hiddenLayer5, in_size=32, out_size=16, activation_function=tf.tanh)

    hiddenLayer7 = add_layer("layer7", hiddenLayer6, in_size=16, out_size=8, activation_function=tf.tanh)

    prediction = add_layer("end", hiddenLayer7, in_size=8, out_size=3)
