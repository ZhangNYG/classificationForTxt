...
def mode_base():
    ...
    hiddenLayer5 = add_layer("layer5", hiddenLayer4, in_size=64, out_size=16, activation_function=tf.tanh)

    prediction = add_layer("end", hiddenLayer5, in_size=16, out_size=3, activation_function=tf.nn.softmax)
