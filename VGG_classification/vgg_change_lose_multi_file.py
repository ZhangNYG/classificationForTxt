...
def mode_base():
    ...
    hiddenLayer1 = add_layer("layer1", pool5_flat, in_size=shape, out_size=4096, activation_function=tf.tanh)

    hiddenLayer2 = add_layer("layer2", hiddenLayer1, in_size=4096, out_size=1024, activation_function=tf.tanh)
